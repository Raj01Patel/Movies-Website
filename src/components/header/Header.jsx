    ...
    return (
        <div className="header">
            <div className="headerLeft">
                <Link to="/"><img className="header__icon" src="https://w7.pngwing.com/pngs/314/157/png-transparent-logo-clapperboard-product-design-marketing-movie-tape-text-service-logo.png" alt="IMDB Logo" /></Link>
